...
String numbmoviesearch = (String) request.getParameter("numbmoviesearch");
%>
...
<h1>Best album of the month</h1>

<script language="JavaScript1.2">
var variableslide=new Array()
variableslide[0]=['/isai/images/Thalaivaa.jpg','','']
variableslide[1]=['/isai/images/Singam_2.jpg','','']
variableslide[2]=['/isai/images/3.jpg','','']
var slidewidth='200px' //set to width of LARGEST image in your slideshow
var slideheight='80px' //set to height of LARGEST iamge in your slideshow, plus any text description
var slidedelay=3000
var ie=document.all
